...
export const getCategoryResultProductList = async ({
  page = 1,
  take = 100,
  firstCategoryId,
  secondCategoryId,
  ...
  if (firstCategoryId)
    searchParams.set("firstCategoryId", firstCategoryId.toString());
  if (secondCategoryId)
    searchParams.set("secondCategoryId", secondCategoryId.toString());
  if (thirdCategoryId)
    searchParams.set("thirdCategoryId", thirdCategoryId.toString());
